 ...
 * @author mfran
 */
public class GetSchedulesUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Log.log.info("-- Get Schedules information for feeder" + request.getParameter("idFeeder") + " from DB --");
